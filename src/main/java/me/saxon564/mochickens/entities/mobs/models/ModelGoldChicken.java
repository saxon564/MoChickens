...
public class ModelGoldChicken extends ModelBase
{
  //fields
    ModelRenderer rleg;
    ModelRenderer lleg;
    ...
    ModelRenderer Head_Spike_1;
    ModelRenderer Head_Spike_2;
    ModelRenderer Head_Spike_3;
  ...
  public ModelGoldChicken()
  {
    ...
    Back_Plate = new ModelRenderer(this, 0, 25);
    ...
    Head_Spike_1 = new ModelRenderer(this, 27, 0);
    ...
    Head_Spike_2 = new ModelRenderer(this, 27, 0);
    ...
    Head_Spike_3 = new ModelRenderer(this, 27, 0);
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
  {
      ...
      if (this.isChild)
      {
          ...
          this.bill.render(f5);
          this.chin.render(f5);
          //this.Head_Spike_1.render(f5);
          this.Head_Spike_2.render(f5);
          //this.Head_Spike_3.render(f5);
          GL11.glPopMatrix();
          GL11.glPushMatrix();
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
  {
      ...
      //this.Head_Spike_1.rotateAngleX = this.head.rotateAngleX;
      //this.Head_Spike_1.rotateAngleY = this.head.rotateAngleY;
      this.Head_Spike_2.rotateAngleX = this.head.rotateAngleX;
      this.Head_Spike_2.rotateAngleY = this.head.rotateAngleY;
      //this.Head_Spike_3.rotateAngleX = this.head.rotateAngleX;
      //this.Head_Spike_3.rotateAngleY = this.head.rotateAngleY;
  }
