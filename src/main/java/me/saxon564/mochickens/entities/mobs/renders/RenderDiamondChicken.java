...
public class RenderDiamondChicken extends RenderLiving
{
    ...
    public RenderDiamondChicken(ModelBase par1ModelBase, float par2)
    {
        super(par1ModelBase, par2);
    }

    public void renderDiamondChicken(EntityDiamondChicken par1EntityDiamondChicken, double par2, double par4, double par6, float par8, float par9)
    {
        super.doRender(par1EntityDiamondChicken, par2, par4, par6, par8, par9);
    }

    protected float getWingRotation(EntityDiamondChicken par1EntityDiamondChicken, float par2)
    {
    ...
    {
        return this.getWingRotation((EntityDiamondChicken)par1EntityLivingBase, par2);
    }

    public void doRenderLiving(EntityLivingBase par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
    {
        this.renderDiamondChicken((EntityDiamondChicken)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.renderDiamondChicken((EntityDiamondChicken)par1Entity, par2, par4, par6, par8, par9);
    }
