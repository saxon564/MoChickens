...
public class EntityGiantChicken extends EntityMoChicken
{
	...
	public void setTamed(boolean par1) {
		...
		if (par1) {
			...
			this.tasks.addTask(3, new ChickAITempt(this, 1.0D,
					MoChickens.tamingDisc, false));
			if (MoChickens.giantTamedDespawn == false) {
				despawn = false;
				ran = 0;
				this.canDespawn();
			} else {
			...
			if (MoChickens.giantUntamedDespawn == false) {
				despawn = false;
				ran = 0;
				this.canDespawn();
			} else {
    ...
    /*public void onLivingUpdate()
    {
        ...
        //if (loc == 0) {
        //	MinecraftServer.getServer().getLogAgent().logInfo("Giant X:" + this.posX + " Y:" + this.posY + " Z:" + this.posZ);
        //	loc ++;
        //}
                ...
                && --this.timeUntilNextEgg == 0)
        {
            ...
            Item drop = MoChickens.randomEgg;
    ...
    {
        this.worldObj.playSoundAtEntity(this, "mochickens:deepCluck",
                                        1.0F, 1.0F);
        return null;
    }
    ...
    {
    	this.worldObj.playSoundAtEntity(this, "mochickens:giantHurt",
                1.0F, 1.0F);
        return null;
    }
    ...
    /*protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (int k = 0; k < j; ++k)
        {
            if (this.isTamed())
            {
                this.dropItem(MoChickens.randomEgg, 1);
            }
            else
            {
    ...
    /*public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (!this.isTamed())
        {
            if (itemstack != null && itemstack.getItem() == MoChickens.tamingDisc)
            {
    ...
    /*public boolean isBreedingItem(ItemStack par1ItemStack)
    {
        if (this.isTamed())
        {
            return par1ItemStack != null && par1ItemStack.getItem() == MoChickens.tamingDisc;
        }
        else
        {
            return false;
