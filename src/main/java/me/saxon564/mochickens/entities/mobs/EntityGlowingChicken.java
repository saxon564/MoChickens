...
public class EntityGlowingChicken extends EntityMoChicken
{
	...
	public void setTamed(boolean par1) {
		...
		if (par1) {
			...
			this.tasks.addTask(3, new ChickAITempt(this, 1.0D,
					Item.getItemFromBlock((Block) Block.blockRegistry.getObject("glowstone")), false));
			if (MoChickens.glowingTamedDespawn == false) {
				despawn = false;
				ran = 0;
				this.canDespawn();
			} else {
			...
			if (MoChickens.glowingUntamedDespawn == false) {
				despawn = false;
				ran = 0;
				this.canDespawn();
			} else {
        ...
        if (!this.isTamed())
        {
            ...
            if (entityplayer instanceof EntityLivingBase)
            {
                ...
                entityplayer.addPotionEffect(new PotionEffect(
                                                 Potion.nightVision.id, 500, 2));
                entityplayer.addPotionEffect(new PotionEffect(
                        Potion.jump.id, 400, 5));
            }
    ...
    /*public void onLivingUpdate()
    {
        ...
        //if (loc == 0) {
        //	MinecraftServer.getServer().getLogAgent().logInfo("Glowing X:" + this.posX + " Y:" + this.posY + " Z:" + this.posZ);
        //	loc ++;
        //}
    ...
    {
        return (Item) Item.itemRegistry.getObject("glowstone_dust");
    }*/
    ...
    /*public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (!this.isTamed())
        {
            if (itemstack != null && itemstack.getItem() == (Item) Item.itemRegistry.getObject("glowstone_dust"))
            {
     ...
     */
    /*public EntityGlowingChicken spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityGlowingChicken entitybluechicken = new EntityGlowingChicken(
            this.worldObj);
        EntityLivingBase s = this.getOwner();
    ...
    /*public boolean isBreedingItem(ItemStack par1ItemStack)
    {
        if (this.isTamed())
        {
            return par1ItemStack != null
                   && par1ItemStack.getItem() == (Item) Item.itemRegistry.getObject("glowstone_dust");
        }
        else
        {
            return false;
