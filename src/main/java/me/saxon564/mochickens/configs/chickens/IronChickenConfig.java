...
public class IronChickenConfig {
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "IronChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 501).getInt(501);
		config.save();
	}
	...
	public static void spawning() { 
		...
		spawnProb = config.get("spawning", "Spawn Probability", 9).getInt(9);
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:iron_ingot").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:iron_block").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:iron_ingot").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:iron_ingot").getString();
