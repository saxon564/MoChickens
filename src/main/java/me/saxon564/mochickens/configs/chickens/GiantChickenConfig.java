...
public class GiantChickenConfig {
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "GiantChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 507).getInt(507);
		config.save();
	}
	...
	public static void spawning() { 
		...
		spawnProb = config.get("spawning", "Spawn Probability", 4).getInt(4);
	...
	public static void entityData()	{
		...
		sizeX = config.get("entity data", "Hit Box Size X", 1.25D).getDouble(1.25D);
		sizeZ = config.get("entity data", "Hit Box Size Z", 2.5D).getDouble(2.5D);
		...
		lightLevel = config.get("entity data", "Light Level Emited", 4).getInt(4);
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "mochickens:taming_disc").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "mochickens:taming_disc").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "mochickens:taming_disc").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "mochickens:random_egg").getString();
		...
		varItemLayTime = config.get("laying", "Variable Item Lay Time", 5000).getInt(5000);
	...
	public static void attackData() {
		...
		attackDamage = (float) config.get("attack data", "Attack Damage", 7.0D).getDouble(7.0D);
