...
public class LapisChickenConfig {
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "LapisChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 503).getInt(503);
		config.save();
	}
	...
	public static void entityData()	{
		...
		health = config.get("entity data", "Health", 8.0D).getDouble(8.0D);
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:dye").getString();
		tameChance = config.get("taming", "Taming Chance", 3).getInt(3);
		tameItemUsesData = config.get("taming", "Taming Item Uses Data", true).getBoolean(true);
		tameItemData = config.get("taming", "Taming Item Data", 4).getInt(4);
	}
		
	public static void tempting() {
		ConfigComments.temptingComments(config);
		temptItem = config.get("tempting", "Tempting Item", "minecraft:lapis_block").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:dye").getString();
		breedItemUsesData = config.get("breeding", "Breeding Item Uses Data", true).getBoolean(true);
		breedItemData = config.get("breeding", "Breeding Item Data", 4).getInt(4);
	}
	...
	public static void laying() {
		...
		layItemData = config.get("laying", "Laying Item Data", 4).getInt(4);
	...
	public static void attackData() {
		...
		attackDamage = (float) config.get("attack data", "Attack Damage", 1.0D).getDouble(1.0D);
