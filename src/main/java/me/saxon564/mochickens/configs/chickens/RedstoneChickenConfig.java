...
public class RedstoneChickenConfig {
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "RedstoneChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 504).getInt(504);
		config.save();
	}
	...
	public static void spawning() { 
		...
		spawnProb = config.get("spawning", "Spawn Probability", 6).getInt(6);
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:redstone").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:redstone_block").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:redstone").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:redstone").getString();
