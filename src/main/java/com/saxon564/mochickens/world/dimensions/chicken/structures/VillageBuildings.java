...
public class VillageBuildings {
    ...
    public static List getStructureVillageWeightedPieceList(Random p_75084_0_, int p_75084_1_)
    {
        ...
        arraylist.add(new VillageBuildings.PieceWeight(VillageBuildings.House4Garden.class, 4, MathHelper.getInt(p_75084_0_, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
        arraylist.add(new VillageBuildings.PieceWeight(VillageBuildings.Church.class, 20, MathHelper.getInt(p_75084_0_, 0 + p_75084_1_, 1 + p_75084_1_)));
        arraylist.add(new VillageBuildings.PieceWeight(VillageBuildings.House1.class, 20, MathHelper.getInt(p_75084_0_, 0 + p_75084_1_, 2 + p_75084_1_)));
        arraylist.add(new VillageBuildings.PieceWeight(VillageBuildings.WoodHut.class, 3, MathHelper.getInt(p_75084_0_, 2 + p_75084_1_, 5 + p_75084_1_ * 3)));
        arraylist.add(new VillageBuildings.PieceWeight(VillageBuildings.Hall.class, 15, MathHelper.getInt(p_75084_0_, 0 + p_75084_1_, 2 + p_75084_1_)));
        arraylist.add(new VillageBuildings.PieceWeight(VillageBuildings.Field1.class, 3, MathHelper.getInt(p_75084_0_, 1 + p_75084_1_, 4 + p_75084_1_)));
        arraylist.add(new VillageBuildings.PieceWeight(VillageBuildings.Field2.class, 3, MathHelper.getInt(p_75084_0_, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
        arraylist.add(new VillageBuildings.PieceWeight(VillageBuildings.House2.class, 15, MathHelper.getInt(p_75084_0_, 0, 1 + p_75084_1_)));
        arraylist.add(new VillageBuildings.PieceWeight(VillageBuildings.House3.class, 8, MathHelper.getInt(p_75084_0_, 0 + p_75084_1_, 3 + p_75084_1_ * 2)));
    ...
    private static int updatePieceWeight(List<VillageBuildings.PieceWeight> p_75079_0_)
    {
        boolean flag = false;
        int i = 0;

        for (VillageBuildings.PieceWeight structurevillagepieces$pieceweight : p_75079_0_)
        {
    ...
    private static VillageBuildings.Village findAndCreateComponentFactory(VillageBuildings.Start start, VillageBuildings.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        Class <? extends VillageBuildings.Village > oclass = weight.villagePieceClass;
        VillageBuildings.Village structurevillagepieces$village = null;

        if (oclass == VillageBuildings.House4Garden.class)
        {
            structurevillagepieces$village = VillageBuildings.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == VillageBuildings.Church.class)
        {
            structurevillagepieces$village = VillageBuildings.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == VillageBuildings.House1.class)
        {
            structurevillagepieces$village = VillageBuildings.House1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == VillageBuildings.WoodHut.class)
        {
            structurevillagepieces$village = VillageBuildings.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == VillageBuildings.Hall.class)
        {
            structurevillagepieces$village = VillageBuildings.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == VillageBuildings.Field1.class)
        {
            structurevillagepieces$village = VillageBuildings.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == VillageBuildings.Field2.class)
        {
            structurevillagepieces$village = VillageBuildings.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == VillageBuildings.House2.class)
        {
            structurevillagepieces$village = VillageBuildings.House2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == VillageBuildings.House3.class)
        {
            structurevillagepieces$village = VillageBuildings.House3.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else
        {
        	structurevillagepieces$village = VillagerRegistry.getVillageComponent(weight, start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }

        return structurevillagepieces$village;
    }

    private static VillageBuildings.Village generateComponent(VillageBuildings.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        else
        {
            ...
            while (j < 5)
            {
                ...
                for (VillageBuildings.PieceWeight villagebuildings$pieceweight : start.structureVillageWeightedPieceList)
                {
                    k -= villagebuildings$pieceweight.villagePieceWeight;

                    if (k < 0)
                    {
                        if (!villagebuildings$pieceweight.canSpawnMoreVillagePiecesOfType(componentType) || villagebuildings$pieceweight == start.structVillagePieceWeight && start.structureVillageWeightedPieceList.size() > 1)
                        {
                            break;
                        }

                        VillageBuildings.Village structurevillagepieces$village = findAndCreateComponentFactory(start, villagebuildings$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);

                        if (structurevillagepieces$village != null)
                        {
                            ++villagebuildings$pieceweight.villagePiecesSpawned;
                            start.structVillagePieceWeight = villagebuildings$pieceweight;

                            if (!villagebuildings$pieceweight.canSpawnMoreVillagePieces())
                            {
                                start.structureVillageWeightedPieceList.remove(villagebuildings$pieceweight);
                            }
            ...
            StructureBoundingBox structureboundingbox = VillageBuildings.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);

            if (structureboundingbox != null)
            {
                return new VillageBuildings.Torch(start, componentType, rand, structureboundingbox, facing);
            }
            else
            {
                return null;
    ...
    private static StructureComponent generateAndAddComponent(VillageBuildings.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        if (componentType > 50)
        {
            return null;
    ...
    private static StructureComponent generateAndAddRoadPiece(VillageBuildings.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = VillageBuildings.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                StructureComponent structurecomponent = new VillageBuildings.Path(start, p_176069_7_, rand, structureboundingbox, facing);
    ...
    public static class Church extends VillageBuildings.Village
    {
        ...
        public Church(VillageBuildings.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
        {
            super(start, type);
        ...
        public static VillageBuildings.Church createPiece(VillageBuildings.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new VillageBuildings.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class Field1 extends VillageBuildings.Village
    {
        ...
        public Field1(VillageBuildings.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static VillageBuildings.Field1 createPiece(VillageBuildings.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new VillageBuildings.Field1(start, p_175851_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class Field2 extends VillageBuildings.Village
    {
        ...
        public Field2(VillageBuildings.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
        {
        ...
        public static VillageBuildings.Field2 createPiece(VillageBuildings.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new VillageBuildings.Field2(start, p_175852_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class Hall extends VillageBuildings.Village
    {
        ...
        public Hall(VillageBuildings.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static VillageBuildings.Hall createPiece(VillageBuildings.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new VillageBuildings.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class House1 extends VillageBuildings.Village
    {
        ...
        public House1(VillageBuildings.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static VillageBuildings.House1 createPiece(VillageBuildings.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new VillageBuildings.House1(start, p_175850_7_, rand, structureboundingbox, facing) : null;
        }
...
public static class House2 extends VillageBuildings.Village
    {
        ...
        public House2(VillageBuildings.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static VillageBuildings.House2 createPiece(VillageBuildings.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new VillageBuildings.House2(start, p_175855_7_, rand, structureboundingbox, facing) : null;
        }
...
public static class House3 extends VillageBuildings.Village
    {
        ...
        public House3(VillageBuildings.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static VillageBuildings.House3 createPiece(VillageBuildings.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new VillageBuildings.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
        }
...
public static class House4Garden extends VillageBuildings.Village
{
    ...
    public House4Garden(VillageBuildings.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
    {
    ...
    public static VillageBuildings.House4Garden createPiece(VillageBuildings.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
    {
        ...
        return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new VillageBuildings.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
    }
...
public static class Path extends VillageBuildings.Road
    {
        ...
        public Path(VillageBuildings.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
        {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            ...
            {
                StructureComponent structurecomponent = this.getNextComponentNN((VillageBuildings.Start)componentIn, listIn, rand, 0, i);
            ...
            {
                StructureComponent structurecomponent1 = this.getNextComponentPP((VillageBuildings.Start)componentIn, listIn, rand, 0, j);
            ...
            if (flag && rand.nextInt(3) > 0 && enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                    	VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                        break;
                    case SOUTH:
                    	VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                        break;
                    case WEST:
                    	VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        break;
                    case EAST:
                    	VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                }
            }
            ...
            if (flag && rand.nextInt(3) > 0 && enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                    	VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                        break;
                    case SOUTH:
                    	VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                        break;
                    case WEST:
                    	VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        break;
                    case EAST:
                    	VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                }
            }
        }

        public static StructureBoundingBox findPieceBox(VillageBuildings.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
        {
...
public static class PieceWeight
    {
        public Class <? extends VillageBuildings.Village > villagePieceClass;
        public final int villagePieceWeight;
        public int villagePiecesSpawned;
        public int villagePiecesLimit;

        public PieceWeight(Class <? extends VillageBuildings.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
        {
...
public abstract static class Road extends VillageBuildings.Village
    {
        ...
        protected Road(VillageBuildings.Start start, int type)
        {
            super(start, type);
        }
    }
...
public static class Start extends VillageBuildings.Chicken
    {
        ...
        public List<VillageBuildings.PieceWeight> structureVillageWeightedPieceList;
        ...
        public Start(BiomeProvider chunkManagerIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_, List<VillageBuildings.PieceWeight> p_i2104_6_, int p_i2104_7_)
        {
            super((VillageBuildings.Start)null, 0, rand, p_i2104_4_, p_i2104_5_);
...
public static class Torch extends VillageBuildings.Village
    {
        ...
        public Torch(VillageBuildings.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
        {
        ...
        public static StructureBoundingBox findPieceBox(VillageBuildings.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
        {
...
public abstract static class Village extends StructureComponent
    {
        ...
        protected VillageBuildings.Start startPiece;

        public Village()
        {
        }

        protected Village(VillageBuildings.Start start, int type)
        {
            super(type);
         ...
         */
        @Nullable
        protected StructureComponent getNextComponentNN(VillageBuildings.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
            ...
            if (enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        return VillageBuildings.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                    case SOUTH:
                        return VillageBuildings.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                    case WEST:
                        return VillageBuildings.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    case EAST:
                        return VillageBuildings.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                }
            }
         ...
         */
        @Nullable
        protected StructureComponent getNextComponentPP(VillageBuildings.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
            ...
            if (enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        return VillageBuildings.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                    case SOUTH:
                        return VillageBuildings.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                    case WEST:
                        return VillageBuildings.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    case EAST:
                        return VillageBuildings.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                }
            }
    ...
    public static class Chicken extends VillageBuildings.Village
        {
            ...
            public Chicken(VillageBuildings.Start start, int type, Random rand, int x, int z)
            {
            	super(start, type);
            ...
            {
                VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
                VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
                VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                VillageBuildings.generateAndAddRoadPiece((VillageBuildings.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
            }
            ...
            public void setBlock(World world, int x, int y, int z, IBlockState block, int metadata)
        	{
        		...
        		if(b1.isAir(b1.getDefaultState(), world, new BlockPos(x, y, z)) || b1.isLeaves(b1.getDefaultState(), world, new BlockPos(x, y, z)))
        		{
            ...
            public boolean addComponentParts(World world, Random rand, StructureBoundingBox box)
            {
                ...
                for (k = 0; k <= 7; k++) {
                	for (l = 0; l <= 11; l++) {
                		super.setBlockState(world, Blocks.FARMLAND.getDefaultState(), k, 0, l, box);
                	}
                }
                ...
                for (k = 0; k <= 7; k++) {
                	for (l = 0; l <= 11; l++) {
                		super.setBlockState(world, Blocks.AIR.getDefaultState(), k, 1, l, box);
                	}
                }
                ...
                //Legs and Feet
        		this.fillWithBlocks(world, box, 1, 1, 2, 6, 1, 3, Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW), Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW), false);
        		this.fillWithBlocks(world, box, 2, 1, 2, 2, 4, 2, Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW), Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW), false);
        		this.fillWithBlocks(world, box, 5, 1, 2, 5, 4, 2, Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW), Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW), false);
        		this.setBlockState(world, Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW), 2, 1, 4, box);
        		this.setBlockState(world, Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW), 5, 1, 4, box);
        		
        		//Body
        		this.fillWithBlocks(world, box, 1, 5, 0, 6, 10, 7, Blocks.SNOW.getDefaultState(), Blocks.SNOW.getDefaultState(), false);
        		this.fillWithBlocks(world, box, 0, 7, 1, 7, 10, 6, Blocks.SNOW.getDefaultState(), Blocks.SNOW.getDefaultState(), false);
        		this.fillWithBlocks(world, box, 2, 7, 1, 5, 9, 6, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
        		this.fillWithBlocks(world, box, 2, 7, 1, 5, 8, 6, Blocks.LAVA.getDefaultState(), Blocks.LAVA.getDefaultState(), false);
        		this.fillWithBlocks(world, box, 3, 7, 3, 4, 7, 4, MoChickens.feather_block.getDefaultState(), MoChickens.feather_block.getDefaultState(), false);
        		
        		//Head
        		this.fillWithBlocks(world, box, 2, 9, 7, 5, 14, 9, Blocks.SNOW.getDefaultState(), Blocks.SNOW.getDefaultState(), false);
        		this.fillWithBlocks(world, box, 2, 11, 10, 5, 12, 11, Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW), Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW), false);
        		this.fillWithBlocks(world, box, 3, 9, 10, 4, 10, 10, Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.RED), Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.RED), false);
        		this.setBlockState(world, Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.BLACK), 2, 13, 9, box);
        		this.setBlockState(world, Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.BLACK), 5, 13, 9, box);
                return true;
            }
        }
    ...
    public static class WoodHut extends VillageBuildings.Village
    {
        ...
        public WoodHut(VillageBuildings.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static VillageBuildings.WoodHut createPiece(VillageBuildings.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new VillageBuildings.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
        }
