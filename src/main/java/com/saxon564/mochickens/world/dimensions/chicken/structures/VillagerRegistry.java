...
import com.saxon564.mochickens.world.dimensions.chicken.structures.VillageBuildings.Village;
...
public class VillagerRegistry
{
    ...
    /**
     * Allow access to the {@link net.minecraft.world.gen.structure.VillageBuildings} array controlling new village
    ...
    public interface IVillageCreationHandler
    {
         ...
         * @param i
         */
        VillageBuildings.PieceWeight getVillagePieceWeight(Random random, int i);
        ...
        /**
         * Build an instance of the village component {@link net.minecraft.world.gen.structure.VillageBuildings}
         * @param villagePiece
         * @param startPiece
         * @param pieces
         * @param random
         ...
         * @param p5
         */
        VillageBuildings.Village buildComponent(VillageBuildings.PieceWeight villagePiece, VillageBuildings.Start startPiece, @SuppressWarnings("rawtypes") List pieces, Random random, int p1,
    ...
    public static void addExtraVillageComponents(@SuppressWarnings("rawtypes") ArrayList components, Random random, int i)
    {
        ...
        List<VillageBuildings.PieceWeight> parts = components;
    ...
    public static VillageBuildings.Village getVillageComponent(VillageBuildings.PieceWeight villagePiece, VillageBuildings.Start startPiece, @SuppressWarnings("rawtypes") List pieces, Random random,
