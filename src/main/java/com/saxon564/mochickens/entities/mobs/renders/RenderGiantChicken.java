...
@OnlyIn(Dist.CLIENT)
public class RenderGiantChicken <T extends EntityGiantChicken, M extends EntityModel<T>> extends  MobRenderer<T, M>
{
    private static final ResourceLocation chickenCTextures = new ResourceLocation(Reference.MOD_ID, "textures/mobs/giantchicken.png");

    public RenderGiantChicken(EntityRendererManager renderManager, M model, float f1)
    {
        super(renderManager, model, f1);
    }

    public void renderGiantChicken(T par1EntityGiantChicken, double par2, double par4, double par6, float par8, float par9)
    {
        super.doRender(par1EntityGiantChicken, par2, par4, par6, par8, par9);
    }

    protected float getWingRotation(T par1EntityGiantChicken, float par2)
    {
    ...
    {
        renderGiantChicken(par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        renderGiantChicken(par1Entity, par2, par4, par6, par8, par9);
    }
