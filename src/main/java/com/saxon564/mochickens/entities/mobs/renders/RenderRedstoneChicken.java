...
@OnlyIn(Dist.CLIENT)
public class RenderRedstoneChicken <T extends EntityRedstoneChicken, M extends EntityModel<T>> extends  MobRenderer<T, M>
{
    private static final ResourceLocation chickenCTextures = new ResourceLocation(Reference.MOD_ID, "textures/mobs/redstonechicken.png");

    public RenderRedstoneChicken(EntityRendererManager renderManager, M model, float f1)
    {
        super(renderManager, model, f1);
    }

    public void renderRedstoneChicken(T par1EntityRedstoneChicken, double par2, double par4, double par6, float par8, float par9)
    {
        super.doRender(par1EntityRedstoneChicken, par2, par4, par6, par8, par9);
    }

    protected float getWingRotation(T par1EntityRedstoneChicken, float par2)
    {
    ...
    {
        renderRedstoneChicken(par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        renderRedstoneChicken(par1Entity, par2, par4, par6, par8, par9);
    }
