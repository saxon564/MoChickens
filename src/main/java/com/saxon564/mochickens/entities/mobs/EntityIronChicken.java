...
public class EntityIronChicken extends EntityMoChicken
{
    ...
    public EntityIronChicken(EntityType<? extends EntityIronChicken> type, World par1World)
    {
    ...
    {
        super.registerAttributes(ConfigHandler.IRON_CHICKEN_CONFIG, getType());
    }
	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		if (j >= 3) {
			entityDropItem(new ItemStack(MoChickens.IRON_CHICKEN_FEATHER, 1), 1);
		}
