...
public class ModelEnderChicken extends ModelBase
{
  //fields
    ModelRenderer rleg;
    ModelRenderer lleg;
  ...
  public ModelEnderChicken()
  {
    ...
    textureHeight = 32;
      ...
      //Head_Spike = new ModelRenderer(this, 48, 0);
      //Head_Spike.addBox(-1F, -5.6F, -5.333333F, 2, 3, 1);
      //Head_Spike.setRotationPoint(0F, 16F, -3F);
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
  {
      ...
      //this.Head_Spike.rotateAngleX = this.head.rotateAngleX;
      //this.Head_Spike.rotateAngleY = this.head.rotateAngleY;
