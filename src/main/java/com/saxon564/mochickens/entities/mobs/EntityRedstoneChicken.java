...
public class EntityRedstoneChicken extends EntityMoChicken
{
    ...
    public EntityRedstoneChicken(EntityType<? extends EntityRedstoneChicken> type, World par1World)
    {
    ...
    {
        super.registerAttributes(ConfigHandler.REDSTONE_CHICKEN_CONFIG, getType());
    }
    ...
    protected void dropFewItems(boolean par1, int par2) {
		...
		if (j >= 3) {
			entityDropItem(new ItemStack(MoChickens.REDSTONE_CHICKEN_FEATHER, 1), 1);
		}
