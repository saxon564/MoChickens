...
public class EntityEmeraldChicken extends EntityMoChicken
{
    ...
    public EntityEmeraldChicken(EntityType<? extends EntityEmeraldChicken> type, World par1World)
    {
    ...
    {
        super.registerAttributes(ConfigHandler.EMERALD_CHICKEN_CONFIG, getType());
    }
    ...
    protected void dropFewItems(boolean par1, int par2) {
		...
		if (j >= 3) {
			entityDropItem(new ItemStack(MoChickens.EMERALD_CHICKEN_FEATHER, 1), 1);
		}
