...
public class ChickAIAttackRangedBow extends EntityAIBase
{
    private final EntityMoChicken entity;
    ...
    public ChickAIAttackRangedBow(EntityMoChicken chicken, double speedAmplifier, int delay, float maxDistance)
    {
        this.entity = chicken;
