...
@OnlyIn(Dist.CLIENT)
public class RenderGlowingChicken <T extends EntityGlowingChicken, M extends EntityModel<T>> extends  MobRenderer<T, M>
{
    ...
    public RenderGlowingChicken(EntityRendererManager renderManager, M model, float f1)
    {
        super(renderManager, model, f1);
    }

    public void renderGlowingChicken(T par1EntityGlowingChicken, double par2, double par4, double par6, float par8, float par9)
    {
        super.doRender(par1EntityGlowingChicken, par2, par4, par6, par8, par9);
    }

    protected float getWingRotation(T par1EntityGlowingChicken, float par2)
    {
    ...
    {
        renderGlowingChicken(par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        renderGlowingChicken(par1Entity, par2, par4, par6, par8, par9);
    }
