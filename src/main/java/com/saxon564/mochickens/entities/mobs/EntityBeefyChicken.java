...
public class EntityBeefyChicken extends EntityMoChicken
{
    ...
    public boolean getCanSpawnHere()
    {
    	...
    	//return this.world.getBlockState(pos.down()) == Blocks.GRASS && this.world.getLight(pos) >= this.minSpawnLightLevel && this.world.getLight(pos) <= this.maxSpawnLightLevel && super.getCanSpawnHere();
