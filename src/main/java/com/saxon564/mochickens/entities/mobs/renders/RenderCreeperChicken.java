...
@OnlyIn(Dist.CLIENT)
public class RenderCreeperChicken <T extends EntityCreeperChicken, M extends EntityModel<T>> extends  MobRenderer<T, M>
{
    ...
    public RenderCreeperChicken(EntityRendererManager renderManager, M model, float f1)
    {
        super(renderManager, model, f1);
    }

    public void renderCreeperChicken(T par1EntityCreeperChicken, double par2, double par4, double par6, float par8, float par9)
    {
        super.doRender(par1EntityCreeperChicken, par2, par4, par6, par8, par9);
    }

    protected float getWingRotation(T par1EntityCreeperChicken, float par2)
    {
    ...
    {
        renderCreeperChicken(par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        renderCreeperChicken(par1Entity, par2, par4, par6, par8, par9);
    }
