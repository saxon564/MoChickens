...
public class ModelRedstoneChicken extends ModelBase
{
  ...
  public ModelRedstoneChicken()
  {
    ...
    textureHeight = 32;
      ...
      Outer_Face = new ModelRenderer(this, 27, 0);
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
  {
      ...
      this.Outer_Face.rotateAngleX = this.head.rotateAngleX;
      this.Outer_Face.rotateAngleY = this.head.rotateAngleY;
