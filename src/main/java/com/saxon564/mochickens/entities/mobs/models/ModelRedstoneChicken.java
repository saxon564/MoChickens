...
public class ModelRedstoneChicken<T extends EntityMoChicken> extends EntityModel<T>
{
  //fields
    RendererModel rleg;
    RendererModel lleg;
  ...
  public ModelRedstoneChicken()
  {
    ...
    textureHeight = 32;
      ...
      Outer_Face = new RendererModel(this, 27, 0);
      Outer_Face.addBox(-1F, -6F, -3F, 2, 2, 1);
      Outer_Face.setRotationPoint(0F, 16F, -4F);
      Outer_Face.setTextureSize(64, 32);
      Outer_Face.mirror = true;
      setRotation(Outer_Face, 0F, 0F, 0F);
  }
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
  {
      ...
      Outer_Face.rotateAngleX = head.rotateAngleX;
      Outer_Face.rotateAngleY = head.rotateAngleY;
