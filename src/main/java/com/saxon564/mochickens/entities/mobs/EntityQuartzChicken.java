...
public class EntityQuartzChicken extends EntityMoChicken
{
    ...
    public EntityQuartzChicken(EntityType<? extends EntityQuartzChicken> type, World par1World)
    {
    ...
    protected void dropFewItems(boolean par1, int par2) {
		...
		if (j >= 3) {
			entityDropItem(new ItemStack(MoChickens.QUARTZ_CHICKEN_FEATHER, 1), 1);
		}
