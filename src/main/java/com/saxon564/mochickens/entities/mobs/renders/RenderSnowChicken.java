...
@OnlyIn(Dist.CLIENT)
public class RenderSnowChicken <T extends EntitySnowChicken, M extends EntityModel<T>> extends  MobRenderer<T, M>
{
    ...
    public RenderSnowChicken(EntityRendererManager renderManager, M model, float f1)
    {
        super(renderManager, model, f1);
    }

    public void renderSnowChicken(T par1EntitySnowChicken, double par2, double par4, double par6, float par8, float par9)
    {
        super.doRender(par1EntitySnowChicken, par2, par4, par6, par8, par9);
    }

    protected float getWingRotation(T par1EntitySnowChicken, float par2)
    {
    ...
    {
        renderSnowChicken(par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        renderSnowChicken(par1Entity, par2, par4, par6, par8, par9);
    }
