...
@OnlyIn(Dist.CLIENT)
public class RenderCookieChicken <T extends EntityCookieChicken, M extends EntityModel<T>> extends  MobRenderer<T, M>
{
    ...
    public RenderCookieChicken(EntityRendererManager renderManager, M model, float f1)
    {
        super(renderManager, model, f1);
    }

    public void renderCookieChicken(T par1EntityCookieChicken, double par2, double par4, double par6, float par8, float par9)
    {
        super.doRender(par1EntityCookieChicken, par2, par4, par6, par8, par9);
    }

    protected float getWingRotation(T par1EntityCookieChicken, float par2)
    {
    ...
    {
        renderCookieChicken(par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        renderCookieChicken(par1Entity, par2, par4, par6, par8, par9);
    }
