...
public class ConfigHandler {
	...
	public static void loadConfig(ForgeConfigSpec spec, File dir, String toml) {
		loadConfig(spec, dir.toPath().resolve(toml));
	}
