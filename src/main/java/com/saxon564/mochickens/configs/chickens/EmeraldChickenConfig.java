...
public class EmeraldChickenConfig {
	...
	public static String[] effectIds = {"minecraft:enchantmenttable"};
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "EmeraldChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 506).getInt(506);
		config.save();
	}
	...
	public static void spawning() { 
		...
		spawnProb = config.get("spawning", "Spawn Probability", 30).getInt(30);
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:emerald").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:emerald_block").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:emerald").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:emerald").getString();
