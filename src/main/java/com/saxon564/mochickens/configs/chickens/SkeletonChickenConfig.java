...
public class SkeletonChickenConfig {
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "SkeletonChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 513).getInt(513);
		config.save();
	}
	...
	public static void spawning() { 
		...
		spawnProb = config.get("spawning", "Spawn Probability", 85).getInt(85);
	...
	public static void entityData()	{
		...
		health = config.get("entity data", "Health", 10.0D).getDouble(10.0D);
		...
		burnsInLight = config.get("entity data", "Burns in Sun", true).getBoolean(true);
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:bone").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:bone").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:bone").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:dye").getString();
		layItemUsesData = config.get("laying", "Laying Item Uses Data", true).getBoolean(true);
		...
		layItemData = config.get("laying", "Laying Item Data", 15).getInt(15);
		...
		varItemLayTime = config.get("laying", "Variable Item Lay Time", 3500).getInt(3500);
	...
	public static void attackData() {
		...
		shootsArrows = config.get("attack data", "Can Shoot Arrows", true).getBoolean(true);
		shootSpeed = config.get("attack data", "Arrow Shoot Speed", 60).getInt(60);
	}
}
