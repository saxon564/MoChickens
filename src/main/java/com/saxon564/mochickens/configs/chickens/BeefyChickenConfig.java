...
public class BeefyChickenConfig {
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "BeefyChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 516).getInt(516);
		config.save();
	}
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:beef").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:cooked_beef").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:cooked_beef").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:cooked_beef").getString();
