...
public class GoldChickenConfig {
	...
	public static String[] effectIds = {"minecraft:blindness"};
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "GoldChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 502).getInt(502);
		config.save();
	}
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:gold_ingot").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:gold_block").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:gold_ingot").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:gold_ingot").getString();
