...
public class SnowChickenConfig {
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "SnowChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 510).getInt(510);
		config.save();
	}
	...
	public static void spawning() { 
		...
		spawnProb = config.get("spawning", "Spawn Probability", 9).getInt(90);
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:snowball").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:snow_block").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:snowball").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:snowball").getString();
		...
		varItemLayTime = config.get("laying", "Variable Item Lay Time", 1000).getInt(1000);
