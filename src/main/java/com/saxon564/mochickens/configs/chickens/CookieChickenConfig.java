...
public class CookieChickenConfig {
	...
	public static String[] effectIds = {"minecraft:speed", "minecraft:nausea"};
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "CookieChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 509).getInt(509);
		config.save();
	}
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:cookie").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:dye").getString();
		temptItemUsesData = config.get("tempting", "Tempting Item Uses Data", true).getBoolean(true);
		temptItemData = config.get("tempting", "Tempting Item Data", 3).getInt(3);
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:cookie").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:cookie").getString();
