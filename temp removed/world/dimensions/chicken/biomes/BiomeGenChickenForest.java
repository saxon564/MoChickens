...
public class BiomeGenChickenForest extends Biome {
	...
	public BiomeGenChickenForest(BiomeProperties id) {
		super(id);
		id.setBaseBiome("Chicken Forest");
		id.setRainDisabled();
		id.setBaseHeight((float)0.3);
		id.setHeightVariation((float)0.3);
	...
	public void decorate(World world, Random rand, BlockPos pos)
    {
        ...
        {
            tx = this.chunk_X + this.RNG.nextInt(16) + 8;
            tz = this.chunk_Z + this.RNG.nextInt(16) + 8;
