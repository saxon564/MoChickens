...
public class BlazingChickenConfig {
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "BlazingChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 518).getInt(518);
		config.save();
	}
	...
	public static void entityData()	{
		...
		health = config.get("entity data", "Health", 15.0D).getDouble(15.0D);
		...
		lightLevel = config.get("entity data", "Light Level Emited", 5).getInt(5);
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:blaze_rod").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:blaze_rod").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:blaze_rod").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:blaze_powder").getString();
		...
		varItemLayTime = config.get("laying", "Variable Item Lay Time", 300).getInt(300);
	...
	public static void attackData() {
		...
		fireTimer = config.get("attack data", "Fire Duration", 7).getInt(7);
