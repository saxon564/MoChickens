...
public class NuuwChickenConfig {
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "NuuwChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 520).getInt(520);
		config.save();
	}
	...
	public static void entityData()	{
		...
		health = config.get("entity data", "Health", 5.0D).getDouble(5.0D);
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:grass").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:grass").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:dirt").getString();
