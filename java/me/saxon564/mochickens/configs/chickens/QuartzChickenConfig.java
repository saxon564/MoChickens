...
public class QuartzChickenConfig {
	...
	public static void setId(FMLPreInitializationEvent event) {
		...
		configFile = new File(path, "QuartzChicken.cfg");
		config = new Configuration(configFile);

		id = config.get("entity data", "ID", 508).getInt(508);
		config.save();
	}
	...
	public static void entityData()	{
		...
		health = config.get("entity data", "Health", 12.0D).getDouble(12.0D);
	...
	public static void taming() {
		...
		tameItem = config.get("taming", "Taming Item", "minecraft:quartz").getString();
	...
	public static void tempting() {
		...
		temptItem = config.get("tempting", "Tempting Item", "minecraft:quartz_block").getString();
	...
	public static void breeding() {	
		...
		breedItem = config.get("breeding", "Breeding Item", "minecraft:quartz").getString();
	...
	public static void laying() {
		...
		layItem = config.get("laying", "Laying Item", "minecraft:quartz").getString();
