...
public abstract class ChickTameable extends EntityAnimal implements IEntityOwnable
{
    ...
    public ChickTameable(World par1World)
    {
        super(par1World);
    }
    ...
    {
        super.entityInit();
        this.customData.addObject(30, Byte.valueOf((byte)0));
        this.customData.addObject(31, "");
    }
    ...
    {
        return (this.customData.getWatchableObjectByte(30) & 4) != 0;
    }

    public void setTamed(boolean par1)
    {
        byte b0 = this.customData.getWatchableObjectByte(30);

        if (par1)
        {
            this.customData.updateObject(30, Byte.valueOf((byte)(b0 | 4)));
        }
        else
        {
            this.customData.updateObject(30, Byte.valueOf((byte)(b0 & -5)));
        }
    }

    public boolean isSitting()
    {
        return (this.customData.getWatchableObjectByte(30) & 1) != 0;
    }
    ...
    public void setSitting(boolean par1)
    {
        ...
        if (par1)
        {
            this.customData.updateObject(30, Byte.valueOf((byte)(b0 | 1)));
        }
        else
        {
            this.customData.updateObject(30, Byte.valueOf((byte)(b0 & -2)));
        }
    }

    public String getOwnerName()
    {
        return this.customData.getWatchableObjectString(31);
    }

    public void setOwner(String par1Str)
    {
        this.customData.updateObject(31, par1Str);
    }
