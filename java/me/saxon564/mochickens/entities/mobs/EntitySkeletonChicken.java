...
public class EntitySkeletonChicken extends EntityMoChicken //implements
    //IRangedAttackMob
{
   ...
   /* public int timeUntilNextEgg;
    ...
    protected boolean canDespawn() {
		if (ran == 0) {
			//System.out.println("Snow Deaspawning is: " + despawn);
			ran = 1;
		}
		return despawn;
	}
	...
	public void setTamed(boolean par1) {
		...
		if (par1) {
            ...
            this.tasks.addTask(3, new ChickAITempt(this, 1.0D,
                                                   (Item) Item.itemRegistry.getObject("bone"), false));
			if (MoChickens.skeletonTamedDespawn == false) {
				despawn = false;
				ran = 0;
				this.canDespawn();
			} else {
			...
			if (MoChickens.skeletonUntamedDespawn == false) {
				despawn = false;
				ran = 0;
				this.canDespawn();
			} else {
    ...
    public void onLivingUpdate()
    {
        ...
        if (loc == 0) {
        	//System.out.println("Skeleton X:" + this.posX + " Y:" + this.posY + " Z:" + this.posZ);
        	//MinecraftServer.getServer().getLogAgent().logInfo("Creeper X:" + this.posX + " Y:" + this.posY + " Z:" + this.posZ);
        	loc++;
        }
    }
    /*  this.field_70888_h = this.field_70886_e;
                ...
                && --this.timeUntilNextEgg == 0)
        {
            ...
            this.entityDropItem(new ItemStack((Item) Item.itemRegistry.getObject("dye"), 1, 15), 1);
            this.timeUntilNextEgg = this.rand.nextInt(3500) + 6000;
        }
    }
    ...
    {
        return (Item) Item.itemRegistry.getObject("bone");
    }*/
    ...
    /*public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (!this.isTamed())
        {
            if (itemstack != null && itemstack.getItem() == (Item) Item.itemRegistry.getObject("bone"))
            {
     ...
     */
    /*public EntitySkeletonChicken spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntitySkeletonChicken entitybluechicken = new EntitySkeletonChicken(
            this.worldObj);
        EntityLivingBase s = this.getOwner();
    ...
    /*public boolean isBreedingItem(ItemStack par1ItemStack)
    {
        if (this.isTamed())
        {
            return par1ItemStack != null
                   && par1ItemStack.getItem() == (Item) Item.itemRegistry.getObject("bone");
        }
        else
        {
            return false;
            ...
            float f)
    {
        EntityArrow entityarrow = new EntityArrow(this.worldObj, this,
                entitylivingbase, 1.6F,
                (float)(14 - this.worldObj.difficultySetting.getDifficultyId() * 4));
        entityarrow.setDamage((double)(f * 2.0F) + this.rand.nextGaussian()
                              * 0.25D
