...
{
    private static final ResourceLocation chickenCTextures = new ResourceLocation("mochickens:textures/mobs/coalChicken.png");

    public RenderCoalChicken(ModelBase par1ModelBase, float par2)
    {
