...
{
    private static final ResourceLocation chickenCTextures = new ResourceLocation("mochickens:textures/mobs/snowChicken.png");

    public RenderSnowChicken(ModelBase par1ModelBase, float par2)
    {
