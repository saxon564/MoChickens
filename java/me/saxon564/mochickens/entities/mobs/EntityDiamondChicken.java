...
public class EntityDiamondChicken extends EntityMoChicken
{
    ...
    public EntityDiamondChicken(World par1World)
    {
        super(par1World);
    ...
    protected boolean canDespawn() {
		if (ran == 0) {
			//System.out.println("Diamond Deaspawning is: " + despawn);
			ran = 1;
		}
		return despawn;
	}
	...
	public void setTamed(boolean par1) {
		...
		if (par1) {
			...
			this.tasks.addTask(3, new ChickAITempt(this, 1.0D,
					Item.getItemFromBlock((Block) Block.blockRegistry.getObject("diamond_block")), false));
			if (MoChickens.diamondTamedDespawn == false) {
				despawn = false;
				ran = 0;
				this.canDespawn();
			} else {
			...
			if (MoChickens.diamondUntamedDespawn == false) {
				despawn = false;
				ran = 0;
				this.canDespawn();
			} else {
    ...
    /*public void onLivingUpdate()
    {
        ...
        //if (loc == 0) {
        //	MinecraftServer.getServer().getLogAgent().logInfo("Diamond X:" + this.posX + " Y:" + this.posY + " Z:" + this.posZ);
        //	loc ++;
        //}
        ...
        {
            this.worldObj.playSoundAtEntity(this, "mochickens:layDiamond",
                                            1.0F, 1.0F);
            this.dropItem((Item) Item.itemRegistry.getObject("diamond"), 1);
    ...
    /*public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (!this.isTamed())
        {
            if (itemstack != null && itemstack.getItem() == (Item) Item.itemRegistry.getObject("diamond"))
            {
     ...
     */
    /*public EntityDiamondChicken spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityDiamondChicken entitybluechicken = new EntityDiamondChicken(
            this.worldObj);
        EntityLivingBase s = this.getOwner();
    ...
    /*public boolean isBreedingItem(ItemStack par1ItemStack)
    {
        if (this.isTamed())
        {
            return par1ItemStack != null
                   && par1ItemStack.getItem() == (Item) Item.itemRegistry.getObject("diamond");
        }
        else
        {
            return false;
