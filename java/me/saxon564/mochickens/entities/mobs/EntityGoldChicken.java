...
public class EntityGoldChicken extends EntityMoChicken
{
    ...
    public EntityGoldChicken(World par1World)
    {
        super(par1World);
    ...
    {
        super.applyEntityAttributes(GoldChickenConfig.config, this.getClass());
	...
	public void setTamed(boolean par1) {
		...
		if (par1) {
			...
			this.tasks.addTask(3, new ChickAITempt(this, 1.0D,
					Item.getItemFromBlock((Block) Block.blockRegistry.getObject("gold_block")), false));
			if (MoChickens.goldTamedDespawn == false) {
				despawn = false;
				ran = 0;
				this.canDespawn();
			} else {
			...
			if (MoChickens.goldUntamedDespawn == false) {
				despawn = false;
				ran = 0;
				this.canDespawn();
			} else {
    ...
    /*public void onLivingUpdate()
    {
        ...
        //if (loc == 0) {
        //	MinecraftServer.getServer().getLogAgent().logInfo("Gold X:" + this.posX + " Y:" + this.posY + " Z:" + this.posZ);
        //	loc ++;
        //}
                ...
                && --this.timeUntilNextEgg == 0)
        {
            ...
            this.dropItem((Item) Item.itemRegistry.getObject("gold_ingot"), 1);
    ...
    {
        return (Item) Item.itemRegistry.getObject("gold_ingot");
    }*/
    ...
    /*public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (!this.isTamed())
        {
            if (itemstack != null && itemstack.getItem() == (Item) Item.itemRegistry.getObject("gold_ingot"))
            {
     ...
     */
    /*public EntityGoldChicken spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityGoldChicken entitybluechicken = new EntityGoldChicken(
            this.worldObj);
        EntityLivingBase s = this.getOwner();
    ...
    /*public boolean isBreedingItem(ItemStack par1ItemStack)
    {
        if (this.isTamed())
        {
            return par1ItemStack != null
                   && par1ItemStack.getItem() == (Item) Item.itemRegistry.getObject("gold_ingot");
        }
        else
        {
            return false;
